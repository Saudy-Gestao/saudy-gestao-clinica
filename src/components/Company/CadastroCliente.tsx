          ...
          <Paper p="xl" withBorder radius="lg">
            ...
            <Stepper.Step description="Informações do cliente">
              <Stack>
                ...
                <TextInput label="E-mail" type="email" value={adminEmail} onChange={(e: ChangeEvent<HTMLInputElement>) => setAdminEmail(normalizeEmail(e.currentTarget.value))} />
            ...
            <Stepper.Step description="Informações da empresa">
              <Stack>
                <TextInput label="CNPJ" value={cnpj} onChange={(e: ChangeEvent<HTMLInputElement>) => setCnpj(formatCNPJ(e.currentTarget.value))} />
