export const queryKeys = {
  ...
  biOverview: ['bi-overview'] as const,
  biOccupancy: ['bi-occupancy'] as const,
  biFinancial: ['bi-financial'] as const,
  biClinical: ['bi-clinical'] as const,
  biResources: ['bi-resources'] as const,
  biAuthorizations: ['bi-authorizations'] as const,
  biTea: ['bi-tea'] as const,
  biReports: ['bi-reports'] as const,
  biCommunication: ['bi-communication'] as const,
  ...
  agendasAdmin: ['agendas-admin'] as const,
